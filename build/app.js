...
(function(Opal) {
  ...
  Opal.add_stubs(['$colorize', '$puts', '$<<', '$error', '$bold', '$last', '$caller', '$attr_reader', '$!', '$is_valid?', '$class', '$raise', '$===', '$==', '$rand', '$is_hex?', '$hex_to_f', '$[]', '$length', '$key?', '$all?', '$is_a?', '$include?', '$private', '$each', '$push', '$/', '$map', '$to_proc', '$each_slice', '$chars', '$to_i', '$to_f', '$attr_accessor', '$new', '$add_object', '$index', '$slice!', '$clear', '$nil?', '$reg_mouse', '$reg_key_down', '$reg_key', '$reg_key_up', '$reg_controller', '$has_key?', '$call', '$downcase', '$[]=', '$get', '$set', '$on', '$on_key', '$on_controller', '$add', '$remove', '$update', '$show', '$close', '$update_color', '$const_defined?', '$<', '$update_coords', '$+', '$width=', '$height=', '$init', '$clip', '$merge!', '$!=', '$animate_frames', '$clip_with_current_frame', '$=~', '$exists?', '$include']);
  (function($base) {
    ...
    (function($base, $super) {
      ...
      Opal.defn(self, '$colorize', TMP_1 = function $$colorize(msg, c) {
        var self = this;

        return "\e[" + (c) + "m" + (msg) + "\e[0m";
      }, TMP_1.$$arity = 2);

      Opal.defn(self, '$error', TMP_2 = function $$error(msg) {
        var self = this;

        return self.$colorize(msg, "4;31");
      }, TMP_2.$$arity = 1);

      Opal.defn(self, '$bold', TMP_3 = function $$bold(msg) {
        var self = this;

        return self.$colorize(msg, "1");
      }, TMP_3.$$arity = 1);

      return (Opal.defn(self, '$initialize', TMP_4 = function $$initialize(msg) {
        var $a, $b, self = this, $iter = TMP_4.$$p, $yield = $iter || nil;

        TMP_4.$$p = null;
        ($a = ($b = self, Opal.find_super_dispatcher(self, 'initialize', TMP_4, false)), $a.$$p = null, $a).call($b, msg);
        return self.$puts(self.$error("\nRuby 2D Error:")['$<<'](" " + (msg))['$<<'](self.$bold("\nOccurred in:\n  " + (self.$caller().$last()) + "\n")));
  ...
  (function($base) {
    ...
    (function($base, $super) {
      ...
      var def = self.$$proto, $scope = self.$$scope, TMP_5, TMP_6, TMP_8, TMP_10, TMP_12;

      self.$attr_reader("r", "g", "b", "a");

      (Opal.cvars['@@colors'] = $hash2(["navy", "blue", "aqua", "teal", "olive", "green", "lime", "yellow", "orange", "red", "brown", "fuchsia", "purple", "maroon", "white", "silver", "gray", "black", "random"], {"navy": "#001F3F", "blue": "#0074D9", "aqua": "#7FDBFF", "teal": "#39CCCC", "olive": "#3D9970", "green": "#2ECC40", "lime": "#01FF70", "yellow": "#FFDC00", "orange": "#FF851B", "red": "#FF4136", "brown": "#663300", "fuchsia": "#F012BE", "purple": "#B10DC9", "maroon": "#85144B", "white": "#FFFFFF", "silver": "#DDDDDD", "gray": "#AAAAAA", "black": "#111111", "random": ""}));

      Opal.defn(self, '$initialize', TMP_5 = function $$initialize(c) {
        var $a, $b, $c, self = this, $case = nil;

        if ((($a = self.$class()['$is_valid?'](c)['$!']()) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          return self.$raise($scope.get('Error'), "`" + (c) + "` is not a valid color")
          } else {
          return (function() {$case = c;if ($scope.get('String')['$===']($case)) {if (c['$==']("random")) {
            return $a = [self.$rand(), self.$rand(), self.$rand(), 1.0], self.r = $a[0], self.g = $a[1], self.b = $a[2], self.a = $a[3], $a
          } else if ((($a = self.$class()['$is_hex?'](c)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
            ...
            return $b = self.$hex_to_f((($c = Opal.cvars['@@colors']) == null ? nil : $c)['$[]'](c)), $a = Opal.to_ary($b), self.r = ($a[0] == null ? nil : $a[0]), self.g = ($a[1] == null ? nil : $a[1]), self.b = ($a[2] == null ? nil : $a[2]), self.a = ($a[3] == null ? nil : $a[3]), $b
          }}else if ($scope.get('Array')['$===']($case)) {return $b = [c['$[]'](0), c['$[]'](1), c['$[]'](2), c['$[]'](3)], $a = Opal.to_ary($b), self.r = ($a[0] == null ? nil : $a[0]), self.g = ($a[1] == null ? nil : $a[1]), self.b = ($a[2] == null ? nil : $a[2]), self.a = ($a[3] == null ? nil : $a[3]), $b}else { return nil }})()
        };
      }, TMP_5.$$arity = 1);

      Opal.defs(self, '$is_hex?', TMP_6 = function(s) {
        var $a, $b, self = this;

        return ($a = (($b = s.$class()['$==']($scope.get('String'))) ? s['$[]'](0)['$==']("#") : s.$class()['$==']($scope.get('String'))), $a !== false && $a !== nil && $a != null ?s.$length()['$=='](7) : $a);
      }, TMP_6.$$arity = 1);

      Opal.defs(self, '$is_valid?', TMP_8 = function(c) {
        var $a, $b, $c, $d, TMP_7, self = this;

        return ((($a = ((($b = (($c = Opal.cvars['@@colors']) == null ? nil : $c)['$key?'](c)) !== false && $b !== nil && $b != null) ? $b : self['$is_hex?'](c))) !== false && $a !== nil && $a != null) ? $a : ($b = (($c = c.$class()['$==']($scope.get('Array'))) ? c.$length()['$=='](4) : c.$class()['$==']($scope.get('Array'))), $b !== false && $b !== nil && $b != null ?($c = ($d = c)['$all?'], $c.$$p = (TMP_7 = function(el){var self = TMP_7.$$s || this, $e;
if (el == null) el = nil;
        return ($e = el['$is_a?']($scope.get('Numeric')), $e !== false && $e !== nil && $e != null ?($range(0.0, 1.0, false))['$include?'](el) : $e)}, TMP_7.$$s = self, TMP_7.$$arity = 1, TMP_7), $c).call($d) : $b));
      }, TMP_8.$$arity = 1);

      self.$private();

      Opal.defn(self, '$to_f', TMP_10 = function $$to_f(a) {
        var $a, $b, TMP_9, self = this, b = nil;

        b = [];
        ($a = ($b = a).$each, $a.$$p = (TMP_9 = function(n){var self = TMP_9.$$s || this;
if (n == null) n = nil;
        return b.$push($rb_divide(n, 255.0))}, TMP_9.$$s = self, TMP_9.$$arity = 1, TMP_9), $a).call($b);
        return b;
      }, TMP_10.$$arity = 1);

      return (Opal.defn(self, '$hex_to_f', TMP_12 = function $$hex_to_f(h) {
        var $a, $b, $c, TMP_11, self = this, a = nil;

        h = ($a = ($b = (h['$[]']($range(1, -1, false))).$chars().$each_slice(2)).$map, $a.$$p = "join".$to_proc(), $a).call($b);
        a = [];
        ($a = ($c = h).$each, $a.$$p = (TMP_11 = function(el){var self = TMP_11.$$s || this;
if (el == null) el = nil;
        return a.$push(el.$to_i(16))}, TMP_11.$$s = self, TMP_11.$$arity = 1, TMP_11), $a).call($c);
        a.$push(255);
        return self.$to_f(a);
      }, TMP_12.$$arity = 1), nil) && 'hex_to_f';
    })($scope.base, null)
  })($scope.base);
  (function($base) {
    var $Ruby2D, self = $Ruby2D = $module($base, 'Ruby2D');
    ...
    (function($base, $super) {
      ...
      var def = self.$$proto, $scope = self.$$scope, TMP_16, TMP_17, TMP_18, TMP_20, TMP_21, TMP_22, TMP_23, TMP_24, TMP_25, TMP_26, TMP_27, TMP_28, TMP_29, TMP_30, TMP_31, TMP_32, TMP_33, TMP_34, TMP_35, TMP_36, TMP_37, TMP_38;

      def.fps_cap = def.title = def.background = def.width = def.height = def.viewport_width = def.viewport_height = def.resizable = def.borderless = def.fullscreen = def.highdpi = def.frames = def.fps = def.mouse_x = def.mouse_y = def.diagnostics = def.objects = def.mouse = def.keys_down = def.on_key_proc = def.keys = def.keys_up = def.on_controller_proc = def.update_proc = def.controller = nil;
      self.$attr_reader("objects");

      self.$attr_accessor("mouse_x", "mouse_y", "frames", "fps");

      Opal.defn(self, '$initialize', TMP_16 = function $$initialize(args) {
        var $a, $b, TMP_13, $c, TMP_14, $d, TMP_15, self = this;

        if (args == null) {
          args = $hash2([], {});
        }
        self.title = ((($a = args['$[]']("title")) !== false && $a !== nil && $a != null) ? $a : "Ruby 2D");
        self.background = $scope.get('Color').$new([0.0, 0.0, 0.0, 1.0]);
        self.width = ((($a = args['$[]']("width")) !== false && $a !== nil && $a != null) ? $a : 640);
        self.height = ((($a = args['$[]']("height")) !== false && $a !== nil && $a != null) ? $a : 480);
        ...
        self.highdpi = false;
        self.frames = 0;
        self.fps_cap = ((($a = args['$[]']("fps")) !== false && $a !== nil && $a != null) ? $a : 60);
        self.fps = self.fps_cap;
        self.vsync = ((($a = args['$[]']("vsync")) !== false && $a !== nil && $a != null) ? $a : true);
        self.mouse_x = 0;
        self.mouse_y = 0;
        self.objects = [];
        $a = [$hash2([], {}), $hash2([], {}), $hash2([], {}), $hash2([], {}), $hash2([], {})], self.keys_down = $a[0], self.keys = $a[1], self.keys_up = $a[2], self.mouse = $a[3], self.controller = $a[4], $a;
        self.on_key_proc = ($a = ($b = $scope.get('Proc')).$new, $a.$$p = (TMP_13 = function(){var self = TMP_13.$$s || this;

        return nil}, TMP_13.$$s = self, TMP_13.$$arity = 0, TMP_13), $a).call($b);
        self.on_controller_proc = ($a = ($c = $scope.get('Proc')).$new, $a.$$p = (TMP_14 = function(){var self = TMP_14.$$s || this;

        return nil}, TMP_14.$$s = self, TMP_14.$$arity = 0, TMP_14), $a).call($c);
        self.update_proc = ($a = ($d = $scope.get('Proc')).$new, $a.$$p = (TMP_15 = function(){var self = TMP_15.$$s || this;

        return nil}, TMP_15.$$s = self, TMP_15.$$arity = 0, TMP_15), $a).call($d);
        return self.diagnostics = false;
      }, TMP_16.$$arity = -1);

      Opal.defn(self, '$get', TMP_17 = function $$get(sym) {
        var self = this, $case = nil;

        return (function() {$case = sym;if ("window"['$===']($case)) {return self}else if ("title"['$===']($case)) {return self.title}else if ("background"['$===']($case)) {return self.background}else if ("width"['$===']($case)) {return self.width}else if ("height"['$===']($case)) {return self.height}else if ("viewport_width"['$===']($case)) {return self.viewport_width}else if ("viewport_height"['$===']($case)) {return self.viewport_height}else if ("resizable"['$===']($case)) {return self.resizable}else if ("borderless"['$===']($case)) {return self.borderless}else if ("fullscreen"['$===']($case)) {return self.fullscreen}else if ("highdpi"['$===']($case)) {return self.highdpi}else if ("frames"['$===']($case)) {return self.frames}else if ("fps"['$===']($case)) {return self.fps}else if ("mouse_x"['$===']($case)) {return self.mouse_x}else if ("mouse_y"['$===']($case)) {return self.mouse_y}else if ("diagnostics"['$===']($case)) {return self.diagnostics}else { return nil }})();
      }, TMP_17.$$arity = 1);

      Opal.defn(self, '$set', TMP_18 = function $$set(opts) {
        var $a, self = this;

        self.title = ((($a = opts['$[]']("title")) !== false && $a !== nil && $a != null) ? $a : self.title);
        if ((($a = $scope.get('Color')['$is_valid?'](opts['$[]']("background"))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          self.background = $scope.get('Color').$new(opts['$[]']("background"))};
        self.width = ((($a = opts['$[]']("width")) !== false && $a !== nil && $a != null) ? $a : self.width);
        self.height = ((($a = opts['$[]']("height")) !== false && $a !== nil && $a != null) ? $a : self.height);
        self.viewport_width = ((($a = opts['$[]']("viewport_width")) !== false && $a !== nil && $a != null) ? $a : self.viewport_width);
        self.viewport_height = ((($a = opts['$[]']("viewport_height")) !== false && $a !== nil && $a != null) ? $a : self.viewport_height);
        self.resizable = ((($a = opts['$[]']("resizable")) !== false && $a !== nil && $a != null) ? $a : self.resizable);
        self.borderless = ((($a = opts['$[]']("borderless")) !== false && $a !== nil && $a != null) ? $a : self.borderless);
        self.fullscreen = ((($a = opts['$[]']("fullscreen")) !== false && $a !== nil && $a != null) ? $a : self.fullscreen);
        self.highdpi = ((($a = opts['$[]']("highdpi")) !== false && $a !== nil && $a != null) ? $a : self.highdpi);
        return self.diagnostics = ((($a = opts['$[]']("diagnostics")) !== false && $a !== nil && $a != null) ? $a : self.diagnostics);
      }, TMP_18.$$arity = 1);

      Opal.defn(self, '$add', TMP_20 = function $$add(o) {
        var $a, $b, TMP_19, self = this, $case = nil;

        return (function() {$case = o;if (nil['$===']($case)) {return self.$raise($scope.get('Error'), "Cannot add '" + (o.$class()) + "' to window!")}else if ($scope.get('Array')['$===']($case)) {return ($a = ($b = o).$each, $a.$$p = (TMP_19 = function(x){var self = TMP_19.$$s || this;
if (x == null) x = nil;
        return self.$add_object(x)}, TMP_19.$$s = self, TMP_19.$$arity = 1, TMP_19), $a).call($b)}else {return self.$add_object(o)}})();
      }, TMP_20.$$arity = 1);

      Opal.defn(self, '$remove', TMP_21 = function $$remove(o) {
        var $a, self = this, i = nil;

        if (o['$=='](nil)) {
          self.$raise($scope.get('Error'), "Cannot remove '" + (o.$class()) + "' from window!")};
        if ((($a = i = self.objects.$index(o)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          self.objects['$slice!'](i);
          return true;
          } else {
          return false
        };
      ...
      Opal.defn(self, '$clear', TMP_22 = function $$clear() {
        var self = this;

        return self.objects.$clear();
      }, TMP_22.$$arity = 0);

      Opal.defn(self, '$update', TMP_23 = function $$update() {
        var self = this, $iter = TMP_23.$$p, proc = $iter || nil;
      ...
      Opal.defn(self, '$on', TMP_24 = function $$on(args) {
        var $a, $b, $c, $d, $e, $f, self = this, $iter = TMP_24.$$p, proc = $iter || nil, mouse = nil, key = nil, key_up = nil, key_down = nil, controller = nil;
        ...
        if ((($a = mouse['$nil?']()) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          } else {
          ($a = ($b = self).$reg_mouse, $a.$$p = proc.$to_proc(), $a).call($b, mouse)
        };
        if ((($a = key_down['$nil?']()) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          } else {
          ($a = ($c = self).$reg_key_down, $a.$$p = proc.$to_proc(), $a).call($c, key_down)
        };
        if ((($a = key['$nil?']()) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          } else {
          ($a = ($d = self).$reg_key, $a.$$p = proc.$to_proc(), $a).call($d, key)
        };
        if ((($a = key_up['$nil?']()) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          } else {
          ($a = ($e = self).$reg_key_up, $a.$$p = proc.$to_proc(), $a).call($e, key_up)
        };
        if ((($a = controller['$nil?']()) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          return nil
          } else {
          return ($a = ($f = self).$reg_controller, $a.$$p = proc.$to_proc(), $a).call($f, controller)
        };
      }, TMP_24.$$arity = -1);

      Opal.defn(self, '$mouse_callback', TMP_25 = function $$mouse_callback(btn, x, y) {
        var $a, self = this;

        if ((($a = self.mouse['$has_key?']("any")) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          return self.mouse['$[]'](btn).$call(x, y)
          } else {
          return nil
        };
      }, TMP_25.$$arity = 3);

      Opal.defn(self, '$on_key', TMP_26 = function $$on_key() {
        var self = this, $iter = TMP_26.$$p, proc = $iter || nil;

        TMP_26.$$p = null;
        self.on_key_proc = proc;
        return true;
      }, TMP_26.$$arity = 0);

      Opal.defn(self, '$key_down_callback', TMP_27 = function $$key_down_callback(key) {
        var $a, self = this;

        key = key.$downcase();
        if ((($a = self.keys_down['$has_key?']("any")) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          self.keys_down['$[]']("any").$call()};
        if ((($a = self.keys_down['$has_key?'](key)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          return self.keys_down['$[]'](key).$call()
          } else {
          return nil
        };
      }, TMP_27.$$arity = 1);

      Opal.defn(self, '$key_callback', TMP_28 = function $$key_callback(key) {
        var $a, self = this;

        key = key.$downcase();
        self.on_key_proc.$call(key);
        if ((($a = self.keys['$has_key?']("any")) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          self.keys['$[]']("any").$call()};
        if ((($a = self.keys['$has_key?'](key)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          return self.keys['$[]'](key).$call()
          } else {
          return nil
        };
      }, TMP_28.$$arity = 1);

      Opal.defn(self, '$key_up_callback', TMP_29 = function $$key_up_callback(key) {
        var $a, self = this;

        key = key.$downcase();
        if ((($a = self.keys_up['$has_key?']("any")) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          self.keys_up['$[]']("any").$call()};
        if ((($a = self.keys_up['$has_key?'](key)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          return self.keys_up['$[]'](key).$call()
          } else {
          return nil
        };
      }, TMP_29.$$arity = 1);

      Opal.defn(self, '$on_controller', TMP_30 = function $$on_controller() {
        var self = this, $iter = TMP_30.$$p, proc = $iter || nil;

        TMP_30.$$p = null;
        self.on_controller_proc = proc;
        return true;
      }, TMP_30.$$arity = 0);

      Opal.defn(self, '$controller_callback', TMP_31 = function $$controller_callback(which, is_axis, axis, val, is_btn, btn, pressed) {
        var self = this;

        return self.on_controller_proc.$call(which, is_axis, axis, val, is_btn, btn, pressed);
      }, TMP_31.$$arity = 7);

      Opal.defn(self, '$update_callback', TMP_32 = function $$update_callback() {
        var self = this;
      ...
      Opal.defn(self, '$add_object', TMP_33 = function $$add_object(o) {
        var $a, self = this;

        if ((($a = self.objects['$include?'](o)['$!']()) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          self.objects.$push(o);
          return true;
          } else {
          return false
      ...
      Opal.defn(self, '$reg_key_down', TMP_34 = function $$reg_key_down(key) {
        var self = this, $iter = TMP_34.$$p, proc = $iter || nil;

        TMP_34.$$p = null;
        self.keys_down['$[]='](key, proc);
        return true;
      }, TMP_34.$$arity = 1);

      Opal.defn(self, '$reg_key', TMP_35 = function $$reg_key(key) {
        var self = this, $iter = TMP_35.$$p, proc = $iter || nil;
      ...
      Opal.defn(self, '$reg_key_up', TMP_36 = function $$reg_key_up(key) {
        var self = this, $iter = TMP_36.$$p, proc = $iter || nil;

        TMP_36.$$p = null;
        self.keys_up['$[]='](key, proc);
        return true;
      }, TMP_36.$$arity = 1);

      Opal.defn(self, '$reg_mouse', TMP_37 = function $$reg_mouse(btn) {
        var self = this, $iter = TMP_37.$$p, proc = $iter || nil;
      ...
      return (Opal.defn(self, '$reg_controller', TMP_38 = function $$reg_controller(event) {
        var self = this, $iter = TMP_38.$$p, proc = $iter || nil;

        TMP_38.$$p = null;
        self.controller['$[]='](event, proc);
        return true;
      }, TMP_38.$$arity = 1), nil) && 'reg_controller';
    })($scope.base, null)
  })($scope.base);
  (function($base) {
    ...
    (function(self) {
      var $scope = self.$$scope, def = self.$$proto, TMP_39, TMP_40, TMP_41, TMP_42, TMP_43, TMP_44, TMP_45, TMP_46, TMP_47, TMP_48, TMP_49;

      (Opal.cvars['@@window'] = (($scope.get('Ruby2D')).$$scope.get('Window')).$new());
      Opal.defn(self, '$get', TMP_39 = function $$get(sym) {
        var $a, self = this;

        return (($a = Opal.cvars['@@window']) == null ? nil : $a).$get(sym);
      }, TMP_39.$$arity = 1);
      Opal.defn(self, '$set', TMP_40 = function $$set(opts) {
        var $a, self = this;

        return (($a = Opal.cvars['@@window']) == null ? nil : $a).$set(opts);
      }, TMP_40.$$arity = 1);
      Opal.defn(self, '$on', TMP_41 = function $$on(args) {
        var $a, $b, $c, self = this, $iter = TMP_41.$$p, proc = $iter || nil;

        if (args == null) {
          args = $hash2([], {});
        }
        TMP_41.$$p = null;
        return ($a = ($b = (($c = Opal.cvars['@@window']) == null ? nil : $c)).$on, $a.$$p = proc.$to_proc(), $a).call($b, args);
      }, TMP_41.$$arity = -1);
      Opal.defn(self, '$on_key', TMP_42 = function $$on_key() {
        var $a, $b, $c, self = this, $iter = TMP_42.$$p, proc = $iter || nil;

        TMP_42.$$p = null;
        return ($a = ($b = (($c = Opal.cvars['@@window']) == null ? nil : $c)).$on_key, $a.$$p = proc.$to_proc(), $a).call($b);
      }, TMP_42.$$arity = 0);
      Opal.defn(self, '$on_controller', TMP_43 = function $$on_controller() {
        var $a, $b, $c, self = this, $iter = TMP_43.$$p, proc = $iter || nil;

        TMP_43.$$p = null;
        return ($a = ($b = (($c = Opal.cvars['@@window']) == null ? nil : $c)).$on_controller, $a.$$p = proc.$to_proc(), $a).call($b);
      }, TMP_43.$$arity = 0);
      Opal.defn(self, '$add', TMP_44 = function $$add(o) {
        var $a, self = this;

        return (($a = Opal.cvars['@@window']) == null ? nil : $a).$add(o);
      }, TMP_44.$$arity = 1);
      Opal.defn(self, '$remove', TMP_45 = function $$remove(o) {
        var $a, self = this;

        return (($a = Opal.cvars['@@window']) == null ? nil : $a).$remove(o);
      }, TMP_45.$$arity = 1);
      Opal.defn(self, '$clear', TMP_46 = function $$clear() {
        var $a, self = this;

        return (($a = Opal.cvars['@@window']) == null ? nil : $a).$clear();
      }, TMP_46.$$arity = 0);
      Opal.defn(self, '$update', TMP_47 = function $$update() {
        var $a, $b, $c, self = this, $iter = TMP_47.$$p, proc = $iter || nil;

        TMP_47.$$p = null;
        return ($a = ($b = (($c = Opal.cvars['@@window']) == null ? nil : $c)).$update, $a.$$p = proc.$to_proc(), $a).call($b);
      }, TMP_47.$$arity = 0);
      Opal.defn(self, '$show', TMP_48 = function $$show() {
        var $a, self = this;

        return (($a = Opal.cvars['@@window']) == null ? nil : $a).$show();
      }, TMP_48.$$arity = 0);
      return (Opal.defn(self, '$close', TMP_49 = function $$close() {
        var $a, self = this;

        return (($a = Opal.cvars['@@window']) == null ? nil : $a).$close();
      }, TMP_49.$$arity = 0), nil) && 'close';
    })(Opal.get_singleton_class(self))
  })($scope.get('Ruby2D'));
  (function($base) {
    var $DSL, self = $DSL = $module($base, 'DSL');

    var def = self.$$proto, $scope = self.$$scope, TMP_50, TMP_51, TMP_52, TMP_53, TMP_54, TMP_55, TMP_56, TMP_57, TMP_58;

    Opal.defn(self, '$get', TMP_50 = function $$get(sym) {
      var self = this;

      return $scope.get('Application').$get(sym);
    }, TMP_50.$$arity = 1);

    Opal.defn(self, '$set', TMP_51 = function $$set(opts) {
      var self = this;

      return $scope.get('Application').$set(opts);
    }, TMP_51.$$arity = 1);

    Opal.defn(self, '$on', TMP_52 = function $$on(args) {
      var $a, $b, self = this, $iter = TMP_52.$$p, proc = $iter || nil;

      if (args == null) {
        args = $hash2([], {});
      }
      TMP_52.$$p = null;
      return ($a = ($b = $scope.get('Application')).$on, $a.$$p = proc.$to_proc(), $a).call($b, args);
    }, TMP_52.$$arity = -1);

    Opal.defn(self, '$on_key', TMP_53 = function $$on_key() {
      var $a, $b, self = this, $iter = TMP_53.$$p, proc = $iter || nil;

      TMP_53.$$p = null;
      return ($a = ($b = $scope.get('Application')).$on_key, $a.$$p = proc.$to_proc(), $a).call($b);
    }, TMP_53.$$arity = 0);

    Opal.defn(self, '$on_controller', TMP_54 = function $$on_controller() {
      var $a, $b, self = this, $iter = TMP_54.$$p, proc = $iter || nil;

      TMP_54.$$p = null;
      return ($a = ($b = $scope.get('Application')).$on_controller, $a.$$p = proc.$to_proc(), $a).call($b);
    }, TMP_54.$$arity = 0);

    Opal.defn(self, '$update', TMP_55 = function $$update() {
      var $a, $b, self = this, $iter = TMP_55.$$p, proc = $iter || nil;

      TMP_55.$$p = null;
      return ($a = ($b = $scope.get('Application')).$update, $a.$$p = proc.$to_proc(), $a).call($b);
    }, TMP_55.$$arity = 0);

    Opal.defn(self, '$clear', TMP_56 = function $$clear() {
      var self = this;

      return $scope.get('Application').$clear();
    }, TMP_56.$$arity = 0);

    Opal.defn(self, '$show', TMP_57 = function $$show() {
      var self = this;

      return $scope.get('Application').$show();
    }, TMP_57.$$arity = 0);

    Opal.defn(self, '$close', TMP_58 = function $$close() {
      var self = this;

      return $scope.get('Application').$close();
    }, TMP_58.$$arity = 0);
  })($scope.get('Ruby2D'));
  (function($base) {
    var $Ruby2D, self = $Ruby2D = $module($base, 'Ruby2D');
    ...
    (function($base, $super) {
      ...
      var def = self.$$proto, $scope = self.$$scope, TMP_59, TMP_60, TMP_61, TMP_62, TMP_64;

      self.$attr_accessor("x1", "y1", "c1", "x2", "y2", "c2", "x3", "y3", "c3", "x4", "y4", "c4");

      self.$attr_reader("color");

      Opal.defn(self, '$initialize', TMP_59 = function $$initialize(x1, y1, x2, y2, x3, y3, x4, y4, c) {
        var $a, self = this;
        ...
        self.type_id = 2;
        $a = [x1, y1, x2, y2, x3, y3, x4, y4], self.x1 = $a[0], self.y1 = $a[1], self.x2 = $a[2], self.y2 = $a[3], self.x3 = $a[4], self.y3 = $a[5], self.x4 = $a[6], self.y4 = $a[7], $a;
        self.color = c;
        self.$update_color(c);
        return self.$add();
      }, TMP_59.$$arity = -1);

      Opal.defn(self, '$color=', TMP_60 = function(c) {
        var self = this;

        self.color = c;
        return self.$update_color(c);
      }, TMP_60.$$arity = 1);

      Opal.defn(self, '$add', TMP_61 = function $$add() {
        var $a, self = this;

        if ((($a = $scope.get('Module')['$const_defined?']("DSL")) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          return $scope.get('Application').$add(self)
          } else {
          return nil
        };
      }, TMP_61.$$arity = 0);

      Opal.defn(self, '$remove', TMP_62 = function $$remove() {
        var $a, self = this;

        if ((($a = $scope.get('Module')['$const_defined?']("DSL")) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          return $scope.get('Application').$remove(self)
          } else {
          return nil
        };
      }, TMP_62.$$arity = 0);
      ...
      return (Opal.defn(self, '$update_color', TMP_64 = function $$update_color(c) {
        var $a, $b, $c, TMP_63, self = this;

        if ((($a = $scope.get('Color')['$is_valid?'](c)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          self.c1 = $scope.get('Color').$new(c);
          self.c2 = $scope.get('Color').$new(c);
          self.c3 = $scope.get('Color').$new(c);
          return self.c4 = $scope.get('Color').$new(c);
        } else if ((($a = (($b = c.$class()['$==']($scope.get('Array'))) ? $rb_lt(c.$length(), 4) : c.$class()['$==']($scope.get('Array')))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          return self.$raise($scope.get('Error'), "Quads require 4 colors, one for each vertex. Only "['$<<']("" + (c.$length()) + " were given."))
        } else if ((($a = ($b = ($c = c)['$all?'], $b.$$p = (TMP_63 = function(el){var self = TMP_63.$$s || this;
if (el == null) el = nil;
        return $scope.get('Color')['$is_valid?'](el)}, TMP_63.$$s = self, TMP_63.$$arity = 1, TMP_63), $b).call($c)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          self.c1 = $scope.get('Color').$new(c['$[]'](0));
          self.c2 = $scope.get('Color').$new(c['$[]'](1));
          self.c3 = $scope.get('Color').$new(c['$[]'](2));
          return self.c4 = $scope.get('Color').$new(c['$[]'](3));
          } else {
          return self.$raise($scope.get('Error'), "Not a valid color for " + (self.$class()))
        };
      }, TMP_64.$$arity = 1), nil) && 'update_color';
    })($scope.base, null)
  })($scope.base);
  (function($base) {
    var $Ruby2D, self = $Ruby2D = $module($base, 'Ruby2D');
    ...
    (function($base, $super) {
      ...
      var def = self.$$proto, $scope = self.$$scope, TMP_65, TMP_66, TMP_67, TMP_68, TMP_69, TMP_70;

      def.width = def.height = def.x = def.y = nil;
      self.$attr_reader("x", "y", "width", "height");

      Opal.defn(self, '$initialize', TMP_65 = function $$initialize(x, y, w, h, c) {
        var $a, self = this;
        ...
        self.type_id = 2;
        $a = [x, y, w, h, c], self.x = $a[0], self.y = $a[1], self.width = $a[2], self.height = $a[3], self.color = $a[4], $a;
        self.$update_coords(x, y, w, h);
        self.$update_color(c);
        return self.$add();
      }, TMP_65.$$arity = -1);

      Opal.defn(self, '$x=', TMP_66 = function(x) {
        var self = this;
      ...
      Opal.defn(self, '$y=', TMP_67 = function(y) {
        var self = this;
      ...
      Opal.defn(self, '$width=', TMP_68 = function(w) {
        var self = this;
      ...
      Opal.defn(self, '$height=', TMP_69 = function(h) {
        var self = this;
      ...
      return (Opal.defn(self, '$update_coords', TMP_70 = function $$update_coords(x, y, w, h) {
        var self = this;
      ...
      }, TMP_70.$$arity = 4), nil) && 'update_coords';
    })($scope.base, $scope.get('Quad'))
  })($scope.base);
  (function($base) {
    var $Ruby2D, self = $Ruby2D = $module($base, 'Ruby2D');
    ...
    (function($base, $super) {
      ...
      var def = self.$$proto, $scope = self.$$scope, TMP_71, TMP_72;

      self.$attr_reader("size");

      Opal.defn(self, '$initialize', TMP_71 = function $$initialize(x, y, s, c) {
        var $a, self = this;
        ...
        self.type_id = 2;
        $a = [x, y, c], self.x = $a[0], self.y = $a[1], self.color = $a[2], $a;
        self.width = self.height = self.size = s;
        self.$update_coords(x, y, s, s);
        self.$update_color(c);
        return self.$add();
      }, TMP_71.$$arity = -1);

      Opal.defn(self, '$size=', TMP_72 = function(s) {
        var $a, $b, $c, $d, self = this;

        return (($a = [(($c = [self.size = s]), $d = self, $d['$height='].apply($d, $c), $c[$c.length-1])]), $b = self, $b['$width='].apply($b, $a), $a[$a.length-1]);
      }, TMP_72.$$arity = 1);

      return self.$private("width=", "height=");
    })($scope.base, $scope.get('Rectangle'))
  })($scope.base);
  (function($base) {
    var $Ruby2D, self = $Ruby2D = $module($base, 'Ruby2D');
    ...
    (function($base, $super) {
      ...
      var def = self.$$proto, $scope = self.$$scope, TMP_73, TMP_74, TMP_75, TMP_76, TMP_78;

      self.$attr_accessor("x1", "y1", "c1", "x2", "y2", "c2", "x3", "y3", "c3");

      self.$attr_reader("color", "type_id");

      Opal.defn(self, '$initialize', TMP_73 = function $$initialize(x1, y1, x2, y2, x3, y3, c) {
        var $a, self = this;
        ...
        self.type_id = 1;
        $a = [x1, y1], self.x1 = $a[0], self.y1 = $a[1], $a;
        $a = [x2, y2], self.x2 = $a[0], self.y2 = $a[1], $a;
        $a = [x3, y3], self.x3 = $a[0], self.y3 = $a[1], $a;
        self.color = c;
        self.$update_color(c);
        return self.$add();
      }, TMP_73.$$arity = -1);

      Opal.defn(self, '$color=', TMP_74 = function(c) {
        var self = this;
      ...
      Opal.defn(self, '$add', TMP_75 = function $$add() {
        var $a, self = this;
      ...
      Opal.defn(self, '$remove', TMP_76 = function $$remove() {
        var $a, self = this;
      ...
      return (Opal.defn(self, '$update_color', TMP_78 = function $$update_color(c) {
        var $a, $b, $c, TMP_77, self = this;

        if ((($a = $scope.get('Color')['$is_valid?'](c)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          self.c1 = $scope.get('Color').$new(c);
          self.c2 = $scope.get('Color').$new(c);
          return self.c3 = $scope.get('Color').$new(c);
        } else if ((($a = (($b = c.$class()['$==']($scope.get('Array'))) ? $rb_lt(c.$length(), 3) : c.$class()['$==']($scope.get('Array')))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          return self.$raise($scope.get('Error'), "Triangles require 3 colors, one for each vertex. Only "['$<<']("" + (c.$length()) + " were given."))
        } else if ((($a = ($b = ($c = c)['$all?'], $b.$$p = (TMP_77 = function(el){var self = TMP_77.$$s || this;
if (el == null) el = nil;
        return $scope.get('Color')['$is_valid?'](el)}, TMP_77.$$s = self, TMP_77.$$arity = 1, TMP_77), $b).call($c)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          self.c1 = $scope.get('Color').$new(c['$[]'](0));
          self.c2 = $scope.get('Color').$new(c['$[]'](1));
          return self.c3 = $scope.get('Color').$new(c['$[]'](2));
          } else {
          return self.$raise($scope.get('Error'), "Not a valid color for " + (self.$class()))
        };
      }, TMP_78.$$arity = 1), nil) && 'update_color';
    })($scope.base, null)
  })($scope.base);
  (function($base) {
    var $Ruby2D, self = $Ruby2D = $module($base, 'Ruby2D');
    ...
    (function($base, $super) {
      ...
      var def = self.$$proto, $scope = self.$$scope, TMP_79, TMP_80, TMP_81, TMP_82;

      self.$attr_accessor("x", "y", "width", "height", "data");

      self.$attr_reader("path", "color");

      Opal.defn(self, '$initialize', TMP_79 = function $$initialize(x, y, path) {
        var $a, self = this;

        self.type_id = 3;
        $a = [x, y, path], self.x = $a[0], self.y = $a[1], self.path = $a[2], $a;
        self.color = $scope.get('Color').$new([1, 1, 1, 1]);
        self.$init(path);
        return self.$add();
      }, TMP_79.$$arity = 3);

      Opal.defn(self, '$color=', TMP_80 = function(c) {
        var self = this;

        return self.color = $scope.get('Color').$new(c);
      }, TMP_80.$$arity = 1);

      Opal.defn(self, '$add', TMP_81 = function $$add() {
        var $a, self = this;
      ...
      return (Opal.defn(self, '$remove', TMP_82 = function $$remove() {
        var $a, self = this;
  ...
  (function($base) {
    ...
    (function($base, $super) {
      ...
      var def = self.$$proto, $scope = self.$$scope, TMP_83, TMP_84, TMP_85, TMP_86, TMP_87, TMP_88, TMP_89, TMP_90, TMP_91;
      ...
      Opal.defn(self, '$initialize', TMP_83 = function $$initialize(x, y, path) {
        var $a, self = this;
      ...
      Opal.defn(self, '$start', TMP_84 = function $$start(x, y, w, h) {
        var self = this;
      ...
      Opal.defn(self, '$add', TMP_85 = function $$add(animations) {
        var self = this;

        return self.animations['$merge!'](animations);
      }, TMP_85.$$arity = 1);

      Opal.defn(self, '$animate', TMP_86 = function $$animate(animation) {
        var $a, self = this;

        if ((($a = self.current_animation['$!='](animation)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          self.current_frame = 0;
          self.current_frame_time = 0;
      ...
      Opal.defn(self, '$reset', TMP_87 = function $$reset() {
        var self = this;
      ...
      Opal.defn(self, '$remove', TMP_88 = function $$remove() {
        var $a, self = this;
      ...
      Opal.defn(self, '$clip', TMP_89 = function $$clip(x, y, w, h) {
        var $a, self = this;

        return $a = [x, y, w, h], self.clip_x = $a[0], self.clip_y = $a[1], self.clip_w = $a[2], self.clip_h = $a[3], $a;
      }, TMP_89.$$arity = 4);

      Opal.defn(self, '$animate_frames', TMP_90 = function $$animate_frames(frames) {
        var $a, self = this;

        if ((($a = $rb_lt(self.current_frame_time, frames['$[]'](self.current_frame)['$[]'](4))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
      ...
      return (Opal.defn(self, '$clip_with_current_frame', TMP_91 = function $$clip_with_current_frame(frames) {
        var self = this;
      ...
      }, TMP_91.$$arity = 1), nil) && 'clip_with_current_frame';
    })($scope.base, null)
  })($scope.base);
  (function($base) {
    var $Ruby2D, self = $Ruby2D = $module($base, 'Ruby2D');
    ...
    (function($base, $super) {
      ...
      var def = self.$$proto, $scope = self.$$scope, TMP_92, TMP_93, TMP_94, TMP_95, TMP_96;

      self.$attr_accessor("x", "y", "data");

      self.$attr_reader("text", "size", "font", "color");

      Opal.defn(self, '$initialize', TMP_92 = function $$initialize(x, y, text, size, font, c) {
        var $a, self = this;
        ...
        self.font = font;
        self.type_id = 5;
        $a = [x, y, size], self.x = $a[0], self.y = $a[1], self.size = $a[2], $a;
        self.text = text;
        self.color = $scope.get('Color').$new(c);
        self.$init();
        return self.$add();
      }, TMP_92.$$arity = -1);

      Opal.defn(self, '$color=', TMP_93 = function(c) {
        var self = this;

        return self.color = $scope.get('Color').$new(c);
      }, TMP_93.$$arity = 1);

      Opal.defn(self, '$add', TMP_94 = function $$add() {
        var $a, self = this;
      ...
      Opal.defn(self, '$remove', TMP_95 = function $$remove() {
        var $a, self = this;
      ...
      return (Opal.defn(self, '$resolve_path', TMP_96 = function $$resolve_path(font) {
        var $a, self = this, font_path = nil;

        if ((($a = $scope.get('RUBY_PLATFORM')['$=~'](/darwin/)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          font_path = "/Library/Fonts/" + (font) + ".ttf"
          } else {
          font_path = "/usr/share/fonts/truetype/" + (font) + ".ttf"
        };
        if ((($a = $scope.get('File')['$exists?'](font_path)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          return font_path
          } else {
          return self.$raise($scope.get('Error'), "Cannot find system font")
        };
      }, TMP_96.$$arity = 1), nil) && 'resolve_path';
    })($scope.base, null)
  })($scope.base);
  (function($base) {
    var $Ruby2D, self = $Ruby2D = $module($base, 'Ruby2D');
    ...
    (function($base, $super) {
      ...
      var def = self.$$proto, $scope = self.$$scope, TMP_97;

      self.$attr_accessor("data");

      self.$attr_reader("path");

      return (Opal.defn(self, '$initialize', TMP_97 = function $$initialize(path) {
        var self = this;

        self.$init(path);
        return self.path = path;
      }, TMP_97.$$arity = 1), nil) && 'initialize';
    })($scope.base, null)
  })($scope.base);
  (function($base) {
    var $Ruby2D, self = $Ruby2D = $module($base, 'Ruby2D');
    ...
    (function($base, $super) {
      ...
      var def = self.$$proto, $scope = self.$$scope, TMP_98;

      self.$attr_accessor("data", "loop");

      self.$attr_reader("path");

      return (Opal.defn(self, '$initialize', TMP_98 = function $$initialize(path) {
        var self = this;

        self.$init(path);
        self.path = path;
        return self.loop = false;
      }, TMP_98.$$arity = 1), nil) && 'initialize';
    })($scope.base, null)
  })($scope.base);
  self.$include((($scope.get('Ruby2D')).$$scope.get('DSL')));
  return self.$include($scope.get('Ruby2D'));
})(Opal);
...
/* Generated by Opal 0.10.3 */
(function(Opal) {
  var $a, $b, self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $gvars = Opal.gvars, $module = Opal.module, $klass = Opal.klass;
  if ($gvars.R2D_WINDOW == null) $gvars.R2D_WINDOW = nil;

  Opal.add_stubs(['$key_down_callback', '$key_callback', '$key_up_callback', '$mouse_callback', '$mouse_x=', '$mouse_y=', '$frames=', '$fps=', '$update_callback', '$r', '$get', '$g', '$b', '$a', '$objects']);
...
function on_key(e, key) {
  switch (e) {
    case S2D.KEYDOWN:
      $gvars.R2D_WINDOW.$key_down_callback(key);
      break;
    
    case S2D.KEY:
      $gvars.R2D_WINDOW.$key_callback(key);
      break;
    
    case S2D.KEYUP:
      $gvars.R2D_WINDOW.$key_up_callback(key);
      break;
  }
}
...
function on_mouse(x, y) {
  $gvars.R2D_WINDOW.$mouse_callback("any", x, y);
}


function update() {
  (($a = [win.mouse.x]), $b = $gvars.R2D_WINDOW, $b['$mouse_x='].apply($b, $a), $a[$a.length-1]);
  (($a = [win.mouse.y]), $b = $gvars.R2D_WINDOW, $b['$mouse_y='].apply($b, $a), $a[$a.length-1]);
  (($a = [win.frames]), $b = $gvars.R2D_WINDOW, $b['$frames='].apply($b, $a), $a[$a.length-1]);
  (($a = [win.fps]), $b = $gvars.R2D_WINDOW, $b['$fps='].apply($b, $a), $a[$a.length-1]);
...
function render() {
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      return (Opal.defn(self, '$init', TMP_1 = function $$init(path) {
        var self = this;

        return self.data = S2D.CreateImage(path);;
      }, TMP_1.$$arity = 1), nil) && 'init'
    })($scope.base, null);
    ...
    (function($base, $super) {
      ...
      return (Opal.defn(self, '$init', TMP_2 = function $$init(path) {
        var self = this;

        return self.data = S2D.CreateSprite(path);;
      }, TMP_2.$$arity = 1), nil) && 'init'
    })($scope.base, null);
    ...
    (function($base, $super) {
      ...
      Opal.defn(self, '$init', TMP_3 = function $$init() {
        ...
        return self.data = S2D.CreateText(self.font, self.text, self.size);;
      }, TMP_3.$$arity = 0);

      return (Opal.defn(self, '$text=', TMP_4 = function(t) {
        var self = this;

        self.text = t;
        return S2D.SetText(self.data, self.text);;
      }, TMP_4.$$arity = 1), nil) && 'text=';
    })($scope.base, null);
    ...
    (function($base, $super) {
      ...
      Opal.defn(self, '$init', TMP_5 = function $$init(path) {
        var self = this;

        return self.data = S2D.CreateSound(path);;
      }, TMP_5.$$arity = 1);

      return (Opal.defn(self, '$play', TMP_6 = function $$play() {
        var self = this;

        return S2D.PlaySound(self.data);;
      }, TMP_6.$$arity = 0), nil) && 'play';
    })($scope.base, null);
    ...
    (function($base, $super) {
      ...
      var def = self.$$proto, $scope = self.$$scope, TMP_7, TMP_8, TMP_9, TMP_10, TMP_11, TMP_12;

      Opal.defn(self, '$init', TMP_7 = function $$init(path) {
        var self = this;

        return self.data = S2D.CreateMusic(path);;
      }, TMP_7.$$arity = 1);

      Opal.defn(self, '$play', TMP_8 = function $$play() {
        var self = this;

        return S2D.PlayMusic(self.data, self.loop);;
      }, TMP_8.$$arity = 0);

      Opal.defn(self, '$pause', TMP_9 = function $$pause() {
        var self = this;

        S2D.PauseMusic();
      }, TMP_9.$$arity = 0);

      Opal.defn(self, '$resume', TMP_10 = function $$resume() {
        var self = this;

        S2D.ResumeMusic();
      }, TMP_10.$$arity = 0);

      Opal.defn(self, '$stop', TMP_11 = function $$stop() {
        var self = this;

        S2D.StopMusic();
      }, TMP_11.$$arity = 0);

      return (Opal.defn(self, '$fadeout', TMP_12 = function $$fadeout(ms) {
        var self = this;

        S2D.FadeOutMusic(ms);
      }, TMP_12.$$arity = 1), nil) && 'fadeout';
    })($scope.base, null);
    ...
    (function($base, $super) {
      ...
      return (Opal.defn(self, '$show', TMP_13 = function $$show() {
        var self = this;
        if ($gvars.R2D_WINDOW == null) $gvars.R2D_WINDOW = nil;
...
(function(Opal) {
  ...
  var $a, $b, TMP_1, TMP_3, TMP_4, $c, TMP_6, self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $hash2 = Opal.hash2;

  Opal.add_stubs(['$*', '$set', '$times', '$new', '$round', '$get', '$update', '$call', '$%', '$+', '$update_with_tick', '$==', '$draw_fps', '$show']);
  Opal.cdecl($scope, 'PIXELS_PER_SQUARE', 16);
  Opal.cdecl($scope, 'SQUARES_WIDTH', 60);
  Opal.cdecl($scope, 'SQUARES_HEIGHT', 40);
  Opal.cdecl($scope, 'WIDTH', $rb_times($scope.get('PIXELS_PER_SQUARE'), $scope.get('SQUARES_WIDTH')));
  Opal.cdecl($scope, 'HEIGHT', $rb_times($scope.get('PIXELS_PER_SQUARE'), $scope.get('SQUARES_HEIGHT')));
  self.$set($hash2(["title", "width", "height"], {"title": "The Game Continues", "width": $scope.get('WIDTH'), "height": $scope.get('HEIGHT')}));
  ($a = ($b = $scope.get('SQUARES_WIDTH')).$times, $a.$$p = (TMP_1 = function(x){var self = TMP_1.$$s || this, $c, $d, TMP_2;
if (x == null) x = nil;
  return ($c = ($d = $scope.get('SQUARES_HEIGHT')).$times, $c.$$p = (TMP_2 = function(y){var self = TMP_2.$$s || this;
if (y == null) y = nil;
    return $scope.get('Image').$new($rb_times($scope.get('PIXELS_PER_SQUARE'), x), $rb_times($scope.get('PIXELS_PER_SQUARE'), y), "assets/ground.png")}, TMP_2.$$s = self, TMP_2.$$arity = 1, TMP_2), $c).call($d)}, TMP_1.$$s = self, TMP_1.$$arity = 1, TMP_1), $a).call($b);
  Opal.defn(Opal.Object, '$draw_fps', TMP_3 = function $$draw_fps() {
    var self = this, fps = nil;

    fps = self.$get("fps").$round(2);
    $scope.get('Rectangle').$new(0, 0, 210, 80, "black");
    return $scope.get('Text').$new(15, 15, "fps: " + (fps), 40, "fonts/arial.ttf");
  }, TMP_3.$$arity = 0);
  self.tick = 0;
  Opal.defn(Opal.Object, '$update_with_tick', TMP_4 = function $$update_with_tick() {
    var $a, $b, TMP_5, self = this, $iter = TMP_4.$$p, block = $iter || nil;

    TMP_4.$$p = null;
    return ($a = ($b = self).$update, $a.$$p = (TMP_5 = function(){var self = TMP_5.$$s || this;
      if (self.tick == null) self.tick = nil;

    block.$call(self.tick);
      return self.tick = ($rb_plus(self.tick, 1))['$%'](60);}, TMP_5.$$s = self, TMP_5.$$arity = 0, TMP_5), $a).call($b);
  }, TMP_4.$$arity = 0);
  ($a = ($c = self).$update_with_tick, $a.$$p = (TMP_6 = function(tick){var self = TMP_6.$$s || this;
if (tick == null) tick = nil;
  if (tick['$=='](0)) {
      return self.$draw_fps()
      } else {
      return nil
    }}, TMP_6.$$s = self, TMP_6.$$arity = 1, TMP_6), $a).call($c);
  return self.$show();
